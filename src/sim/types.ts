export interface SkyGenParams {
  ...
  edgeFalloffStart: number;  // 0.55–1.0, default 0.92
  ...
  maxProjectionRadius: number; // max 2D sky radius used during generation; keep <= 1 for hemisphere-safe output
}
