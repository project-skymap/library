...
const StarRenderModule_1 = require("../src/engine-next/modules/StarRenderModule");
const ConstellationLinesModule_1 = require("../src/engine-next/modules/ConstellationLinesModule");
const fakeRenderer = {
    setPixelRatio: (_v) => undefined,
    setSize: (_w, _h, _updateStyle) => undefined,
    render: (_scene, _camera) => undefined,
};
...
const stars = new StarRenderModule_1.StarRenderModule({
...
const lines = new ConstellationLinesModule_1.ConstellationLinesModule({ scene });
lines.setConfig(cfg);
